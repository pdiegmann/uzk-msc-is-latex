...
\usepackage{includes/l3packages/xparse/xparse}

\newcommand{\citewithoptionalparams}[3]{\ifthenelse{\equal{#2}{}}{\ifthenelse{\equal{#1}{}}{\cite{#3}}{\cite[#1]{#3}}}{\cite[#1][#2]{#3}}}

\DeclareDocumentCommand{\citeby}{ O{} O{} m O{} O{} m }{\footnote{\citewithoptionalparams{#1}{#2}{#3} as cited by \citewithoptionalparams{#4}{#5}{#6}}}
